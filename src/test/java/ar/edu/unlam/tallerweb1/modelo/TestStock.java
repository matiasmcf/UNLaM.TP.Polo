...
public class TestStock {
	...
	private Ingrediente	condimento	= new Ingrediente("ingredienteTest", 1.5, TipoIngrediente.CONDIMENTO);
	private Ingrediente	ingrediente	= new Ingrediente("condimentoTest", 3., TipoIngrediente.INGREDIENTE);
